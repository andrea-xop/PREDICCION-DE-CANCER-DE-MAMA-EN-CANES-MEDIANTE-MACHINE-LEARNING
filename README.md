# Análisis transcriptómico del cáncer mamario canino
...
El repositorio incluye el código empleado para:
...
Todo el código necesario para reproducir los análisis realizados en el TFM se encuentra disponible en este repositorio.
